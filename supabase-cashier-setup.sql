...
CREATE POLICY "Permitir tudo para usuários autenticados em cashier_sessions"
ON public.cashier_sessions FOR ALL TO authenticated
USING (true) WITH CHECK (true);

CREATE POLICY "Permitir tudo para usuários autenticados em cashier_movements"
ON public.cashier_movements FOR ALL TO authenticated
USING (true) WITH CHECK (true);
